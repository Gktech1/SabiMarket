...
namespace SabiMarket.Infrastructure.Migrations
{
    ...
    [Migration("20250722234643_purchases")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SabiMarket.Domain.Entities.MarketParticipants.TraderBuildingType", b =>
                {
                    ...
                    b.Property<int>("NumberOfBuildingTypes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SabiMarket.Domain.Entities.WaiveMarketModule.CustomerWaiveProductPurchase", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("CustomerWaiveProductPurchases");
                });
            ...
            modelBuilder.Entity("SabiMarket.Domain.Entities.WaiveMarketModule.Vendor", b =>
                {
                    ...
                    b.Property<int?>("VendorCurrencyType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SabiMarket.Domain.Entities.WaiveMarketModule.WaiveMarketDates", b =>
                {
                    ...
                    b.Property<DateTime>("NextWaiveMarketDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("UpdatedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("WaiveMarketLocation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SabiMarket.Domain.Entities.WaiveMarketModule.CustomerWaiveProductPurchase", b =>
                {
                    b.HasOne("SabiMarket.Domain.Entities.WaiveMarketModule.Customer", "Customer")
                        .WithMany("CustomerWaiveProductPurchases")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SabiMarket.Domain.Entities.WaiveMarketModule.Subscription", b =>
                {
                    ...
                    b.HasOne("SabiMarket.Domain.Entities.WaiveMarketModule.SubscriptionPlan", "SubscriptionPlan")
            ...
            modelBuilder.Entity("SabiMarket.Domain.Entities.WaiveMarketModule.WaiveMarketNotification", b =>
                {
                    b.HasOne("SabiMarket.Domain.Entities.WaiveMarketModule.Customer", "Customer")
                        .WithMany("WaiveMarketNotifications")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SabiMarket.Domain.Entities.WaiveMarketModule.Customer", b =>
                {
                    b.Navigation("CustomerWaiveProductPurchases");

                    b.Navigation("Feedbacks");

                    b.Navigation("Orders");

                    b.Navigation("WaiveMarketNotifications");
